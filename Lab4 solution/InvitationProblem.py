...
# The specification of an Invitation problem in the shape of all candidates and
# the constraints
class InvitationProblem:
    ...
    # We want Sofie and Tom to hook up. They should therefore both be at the party
    @staticmethod
    ...
    # Everyone should have the first letter of their name be unique
    @staticmethod
    def constraint6(assignment):
        ...
        for candidate in InvitationProblem.all_candidates:
            if assignment.is_invited(candidate):
                ...
                if letters.__contains__(first_letter):
                    count += 1
